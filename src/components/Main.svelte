<script>
    ...
    let steps = [
        {
            ...
            description:
                "Replicates Amazon's key features: product browsing, user authentication, shopping cart, checkout, and order tracking. Built with React.js, Node.js, MongoDB, and Stripe. Offers scalability and potential feature growth. Provides hands-on full-stack e-commerce development experience.",
        },
        {
            name: "Unisync",
    ...
    let benefits = [
        ...
        {
            name: "Embrace the Future with Innovation",
            description:"Passionate about exploring the latest in technology, I immerse myself in the ever-evolving world of innovation. From cutting-edge advancements to emerging trends, I thrive on uncovering new possibilities and pushing boundaries. With a relentless curiosity and a thirst for knowledge, I embrace challenges as opportunities to learn and grow. My journey in technology is not just about keeping up; it's about staying ahead, shaping the future, and making a meaningful impact.",
        },
    ];
</script>
    ...
    >
        ...
        >
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi! I'm <span class="poppins text-violet-400">Gautam </span> Nair
                <br />Web Designer and
                <span class="poppins text-violet-400">Data Analytic Enthusiast</span>
            </h2>
            <p class="text-base sm:text-lg md:text-xl">
                My <span class="text-violet-400"> favorite tech</span> includes JavaScript
                (NEXT.JS or SvelteKit), TailwindCSS,Machine learning frameworks,Data visualization, <br>UI/UX,Python Development, Cloud Computing 
            </p>
            <button
    onclick="window.location.href='mailto:gautamnair94@gmail.com';"
...
>
    ...
    <h4 class="relative z-9">Get in touch &rarr;</h4>
        ...
        <div class="relative shadow-2xl grid place-items-center">
            ...
            <img
                src={"assets/images/Gautam_nair .jpg"}
                alt="Image of gautam Nair"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-10">
            <Step step={steps[0]}>
                <p>
                        ...
                        Replicates Amazon's key features: product browsing, user authentication, shopping cart, checkout, and order tracking. <strong
                        class="text-violet-400">Built with React.js, Node.js, MongoDB, and Stripe. </strong>Offers scalability and potential feature growth. Provides hands-on full-stack e-commerce development experience.
                </p>
            </Step>
            <Step step={steps[1]}>
                <p>
                     <strong class="text-violet-400">
                        UniSync, a Flutter app, connects like-minded individuals</strong>. Users create profiles, sparking connections via a smart algorithm. Private messaging, community engagement, and event discovery are key features. UniSync prioritizes privacy and security, fostering safe connections and meaningful interactions
                </p>
            </Step>
            <Step step={steps[2]}>
                <p>
                    The Global Suicide Rate Data Analytics project delves into worldwide suicide trends to extract actionable insights. By analyzing data from diverse sources, it uncovers key patterns and correlations, informing targeted prevention strategies for policymakers and mental health professionals globally.
                </p>
            </Step>
        </div>
        <div class="btn btn-info ">
            <button onclick="window.open('https://goku0090.github.io/Project_page/', '_blank')" class="btn">
                Explore More
            </button>
        </div>
